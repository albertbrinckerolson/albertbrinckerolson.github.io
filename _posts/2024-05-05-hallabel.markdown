...
<h3 style="text-align:center;"><iframe src="/NumSales.html"
    sandbox="allow-same-origin allow-scripts"
    width="130%"
    height="500"
    scrolling="no"
...
<h3 style="text-align:center;"><iframe src="/Heat_scatter_Map.html"
    sandbox="allow-same-origin allow-scripts"
    width="100%"
    height="700"
    scrolling="no"
...
<h3 style="text-align:center;"><iframe src="/Scatter_map.html"
    sandbox="allow-same-origin allow-scripts"
    width="100%"
    height="700"
    scrolling="no"
